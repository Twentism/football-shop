...
SECRET_KEY = 'django-insecure-%_cdqz8#(#&4)l0_yk3s*%w65*vs&lowf0esgasuau(m^^7jct'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", 'melanton-gabriel-footballshop.pbp.cs.ui.ac.id', '10.0.2.2']
